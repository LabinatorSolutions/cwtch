...
```
## Plan
Try perspective, quantisation, adam2, srelu, screlu, halfk* (with >> self gen data), buckets, different stretch, etc. At some point reboot from a random init or Lozza HCE. 
## Acknowledgements
