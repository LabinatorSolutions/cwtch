...
## To Testers
Feel free to test Cwtch but beware it's early days and there may be gremlins. Please download the latest release rather than use the repo version, which is knobbled a bit for development purposes. Note that the PV is currently just the best move and there are no hash updates. 
## Goal
